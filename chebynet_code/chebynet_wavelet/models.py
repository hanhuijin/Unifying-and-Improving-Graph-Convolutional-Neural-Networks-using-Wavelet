...
class Wave_Cheby_Neural_Network(Model):
    def __init__(self, node_num, weight_normalize, placeholders, input_dim, **kwargs):
        super(Wave_Cheby_Neural_Network, self).__init__(**kwargs)
    ...
    def _build(self):
        self.layers.append(Wave_Cheby_Convolution(node_num=self.node_num,
...
class GCN2(Model):
    ...
    def _build(self):
        self.layers.append(GraphConvolution2(node_num=self.node_num,
                                             weight_normalize=self.weight_normalize,
                                             input_dim=self.input_dim,
                                             output_dim=FLAGS.hidden1,
                                             placeholders=self.placeholders,
...
class Spectral_CNN(Model):
    ...
    def _build(self):
        self.layers.append(Spetral_Convolution_try(node_num=self.node_num,
                                                   weight_normalize=self.weight_normalize,
                                                   input_dim=self.input_dim,
                                                   output_dim=FLAGS.hidden1,
                                                   placeholders=self.placeholders,
