...
class NodeClassificationDCNN(object):
    ...
    def fit(self, X, Y, train_indices, valid_indices):
        #______________________________________________________________________________plus
        import os
        import random
        def seed_torch(seed=1029):
            ...
            np.random.seed(seed)
        seed_torch(4)
        #__________________________________________________________________________________plus
        num_nodes = X.shape[0]
        ...
        for epoch in range(self.params.num_epochs):
            ...
            train_loss_list.append(train_loss)# plus
            val_loss_list.append(valid_loss)# plus
            ...
            if self.params.print_train_accuracy:
                ...
                train_acc_list.append(metrics.accuracy_score(predictions, actuals))
            ...
            if self.params.print_valid_accuracy:
                ...
                val_acc_list.append(metrics.accuracy_score(predictions, actuals))
